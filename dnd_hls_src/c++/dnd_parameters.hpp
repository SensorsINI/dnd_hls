...
#define TIMESTAMP_POLARITY_DATA_BITS TIMESTAMP_BITS+POLARITY_BITS
#define COMBINED_SPIKES 32
#define TIMESTAMP_POLARITY_IMAGE_DATA_BITS (TIMESTAMP_BITS+POLARITY_BITS) * COMBINED_SPIKES
#define TAU_BITS 6
...
#define MEMORY_DIM_1 400
#define MEMORY_DIM_2 9

typedef ap_uint<TIMESTAMP_POLARITY_IMAGE_DATA_BITS> timestamp_polarity_image_data_t;
typedef ap_uint<TIMESTAMP_POLARITY_DATA_BITS> timestamp_polarity_data_t;
...
#define MLP_INPUT_ACTIVATION_INT_BITS 6
